# Generated by Django 3.2.18 on 2023-05-19 11:37
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('display_name', models.CharField(db_index=True, max_length=255, unique=True)),
                ...
                ('pricing_plan', models.CharField(db_index=True, max_length=10, unique=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('navigateTo', models.CharField(blank=True, max_length=255, null=True)),
                ('category', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.usecasecategory')),
            ],
            options={
                'ordering': ['-created_at', '-updated_at'],
                'abstract': False,
